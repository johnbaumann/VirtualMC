...
// 6 PWM
#define digitalPinToTimer(P) \
        (((P) == 6 || (P) == 5) ? &TCCR0A : (((P) == 9 || (P) == 10) ? &TCCR1A : (((P) == 11 || (P) == 3) ? &TCCR2A : 0)))
#define digitalPinToTimerBit(P) \
        (((P) == 6) ? COM0A1 : (((P) == 5) ? COM0B1 : (((P) == 9) ? COM1A1 : (((P) == 10) ? COM1B1 : (((P) == 11) ? COM2A1 : COM2B1)))))
#endif
...
// 15 PWM
#define digitalPinToTimer(P) \
        (((P) == 13 || (P) == 4) ? &TCCR0A : (((P) == 11 || (P) == 12) ? &TCCR1A : (((P) == 10 || (P) == 9) ? &TCCR2A : (((P) == 5 || (P) == 2 || (P) == 3) ? &TCCR3A : (((P) == 6 || (P) == 7 || (P) == 8) ? &TCCR4A : (((P) == 46 || (P) == 45 || (P) == 44) ? &TCCR5A : 0))))))
#define digitalPinToTimerBit(P) \
        (((P) == 13) ? COM0A1 : (((P) == 4) ? COM0B1 : (((P) == 11) ? COM1A1 : (((P) == 12) ? COM1B1 : (((P) == 10) ? COM2A1 : (((P) == 9) ? COM2B1 : (((P) == 5) ? COM3A1 : (((P) == 2) ? COM3B1 : (((P) == 3) ? COM3C1 : (((P) == 6) ? COM4A1 : (((P) == 7) ? COM4B1 : (((P) == 8) ? COM4C1 : (((P) == 46) ? COM5A1 : (((P) == 45) ? COM5B1 : COM5C1))))))))))))))
